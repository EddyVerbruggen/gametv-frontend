...
notification_item_homepage_begforreview_android = 'Tevreden met deze app? <a href="market://details?id=nl.x_services.gametv" onclick="hideNotification(\'homepage_begforreview_android\')"><i class="icon-star"/> Beoordeel Game TV <i class="icon-star"/></a> en geef tips voor verbeteringen in de comments. Bedankt!';
